...
-- STA alignment reference data (sta_featuretype / sta_relationrole) ------------------
INSERT INTO sta_featuretype (id, ftid, source_table, name, definition, description) VALUES (1, 'ft-soilsite', 'soilsite', 'Soil Site', 'https://inspire.ec.europa.eu/featureconcept/SoilSite', 'INSPIRE Soil Site feature concept.');
INSERT INTO sta_featuretype (id, ftid, source_table, name, definition, description) VALUES (2, 'ft-soilplot', 'soilplot', 'Soil Plot', 'https://inspire.ec.europa.eu/featureconcept/SoilPlot', 'INSPIRE Soil Plot feature concept.');
INSERT INTO sta_featuretype (id, ftid, source_table, name, definition, description) VALUES (3, 'ft-soilprofile', 'soilprofile', 'Soil Profile', 'https://inspire.ec.europa.eu/featureconcept/SoilProfile', 'INSPIRE Soil Profile feature concept.');
INSERT INTO sta_featuretype (id, ftid, source_table, name, definition, description) VALUES (4, 'ft-profileelement', 'profileelement', 'Profile Element', 'https://inspire.ec.europa.eu/featureconcept/ProfileElement', 'INSPIRE Profile Element feature concept.');
INSERT INTO sta_featuretype (id, ftid, source_table, name, definition, description) VALUES (5, 'ft-soilbody', 'soilbody', 'Soil Body', 'https://inspire.ec.europa.eu/featureconcept/SoilBody', 'INSPIRE Soil Body feature concept.');
INSERT INTO sta_featuretype (id, ftid, source_table, name, definition, description) VALUES (6, 'ft-soilderivedobject', 'soilderivedobject', 'Soil Derived Object', 'https://inspire.ec.europa.eu/featureconcept/SoilDerivedObject', 'INSPIRE Soil Derived Object feature concept.');
INSERT INTO sta_relationrole (id, roleid, name, inversename, source_table, fk_column, target_table, definition, inversedefinition) VALUES (1, 'role-locatedon', 'locatedOn', 'isObservedOnLocation', 'soilplot', 'locatedon', 'soilsite', 'A SoilPlot is locatedOn a SoilSite.', 'A SoilSite is observed on the location of a SoilPlot.');
INSERT INTO sta_relationrole (id, roleid, name, inversename, source_table, fk_column, target_table, definition, inversedefinition) VALUES (2, 'role-location', 'location', 'observedProfile', 'soilprofile', 'location', 'soilplot', 'A SoilProfile''s location is a SoilPlot.', 'A SoilPlot is the observed profile location of a SoilProfile.');
INSERT INTO sta_relationrole (id, roleid, name, inversename, source_table, fk_column, target_table, definition, inversedefinition) VALUES (3, 'role-ispartof', 'isPartOf', 'isDescribedBy', 'profileelement', 'ispartof', 'soilprofile', 'A ProfileElement isPartOf a SoilProfile.', 'A SoilProfile is described by its ProfileElements.');
