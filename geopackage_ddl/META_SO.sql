...
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('observedproperty', 'source', 'Source', 'Source', 'Indicate the origin of the data. In the case of the insertion of new properties by the user, these will be marked with the label «Local».', null, null);
...
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('unitofmeasure', 'qudt_unit', 'Qudt Unit', 'Qudt Unit', 'QUDT code, unit expressed using QUDT (Quantities, Units, Dimensions, and Data Types). https://qudt.org/vocab/unit/', null, null);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('unitofmeasure', 'base_qudt_unit', 'Base Qudt Unit', 'Base Qudt Unit', 'Base QUDT unit to define conversionmultiplier & conversionoffset. Generally SI (International System of Units) apart from pH; m/m; mm/m; a. Conversion offset and multiplier are referred as conversion factors from the UCUM unit to the Base QUDT unit.', null, null);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('unitofmeasure', 'base_qudt_label', 'Base Qudt Label', 'Base Qudt Label', 'QUDT label of the Base QUDT unit to define conversionmultiplier & conversionoffset. Generally SI (International System of Units) apart from pH; m/m; mm/m; a. Conversion offset and multiplier are referred as conversion factors from the UCUM unit to the Base QUDT unit.', null, null);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('unitofmeasure', 'conversionoffset', 'Conversion Offset', 'Conversion Offset', 'Additive adjustment used when converting a value from the UCUM unit to the Base QUDT unit.', null, null);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('unitofmeasure', 'conversionmultiplier', 'Conversion Multiplier', 'Conversion Multiplier', 'Numeric factor used to convert from the UCUM unit to the Base QUDT unit.', null, null);
...
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('view_observation','ssLocalid','SoilSite LocalId','Soil Site Local Identifier','Local identifier of the Soil Site associated with the observation.',NULL,NULL);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('view_observation','spLocalid','SoilProfile LocalId','Soil Profile Local Identifier','Local identifier of the Soil Profile associated with the observation.',NULL,NULL);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('view_observation','peLocalid','ProfileElement LocalId','Profile Element Local Identifier','Local identifier of the Profile Element where the observation was taken.',NULL,NULL);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('view_observation','FOIType','Feature-of-Interest Type','Feature of Interest Type','Indicates the type of Feature of Interest (Soil Site, Soil Profile, Profile Element, or Soil Derived Object).',NULL,NULL);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('view_observation','upperLimit','Upper Depth','Upper Depth Limit','Upper depth limit of the profile element (cm).',NULL,NULL);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('view_observation','lowerLimit','Lower Depth','Lower Depth Limit','Lower depth limit of the profile element (cm).',NULL,NULL);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('view_observation','time','Observation Time','Phenomenon Time','Timestamp when the observed phenomenon occurred.',NULL,NULL);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('view_observation','property','Observed Property','Observed Property','Name of the observed property associated with the datastream.',NULL,NULL);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('view_observation','procedure','Procedure','Observation Procedure','Name of the observing procedure used to obtain the observation.',NULL,NULL);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('view_observation','category_value','Category Result','Categorical Result','Categorical result of the observation (for Category-type datastreams).',NULL,NULL);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('view_observation','boolean_value','Boolean Result','Boolean Result','Boolean result of the observation (for Boolean-type datastreams).',NULL,NULL);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('view_observation','quantity_value','Quantity Result','Quantity Result','Numeric result of the observation (for Quantity-type datastreams).',NULL,NULL);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('view_observation','count_value','Count Result','Count Result','Integer count result (for Count-type datastreams).',NULL,NULL);