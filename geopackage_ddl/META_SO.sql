...
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('feature', 'feature_soilsite', 'FK Feature Soil Site', 'FK Feature Soil Site', 'The detailed description of the feature Soil Site. The data type is defined by encodingType.', null, null);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('feature', 'feature_soilprofile', 'FK Feature Soil Profile', 'FK Feature Soil Profile', 'The detailed description of the feature Soil Profile. The data type is defined by encodingType.', null, null);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('feature', 'feature_profileelement', 'FK Feature Profile Element', 'FK Feature Profile Element', 'The detailed description of the feature Profile Element. The data type is defined by encodingType.', null, null);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('feature', 'feature_soilderivedobject', 'FK Feature Soil Derived Object', 'FK Feature Soil Derived Object', 'The detailed description of the feature Soil Derived Object. The data type is defined by encodingType.', null, null);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('feature', 'idfeaturetype', 'FK Feature Type', 'FK Feature Type', 'Foreign key to the Feature Type table, id field.', null, null);
...
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('datastream', 'iduom', 'FK Unit Of Measure', 'FK Unit Of Measure','A Unit of Measure is a standard quantity used to express and compare measurements.', null, null);
...
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('datastream', 'idthing', 'FK Thing', 'FK Thing', 'Foreign key to the Thing table, id field.', null, null);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('datastream', 'idsensor', 'FK Sensor', 'FK Sensor', 'Foreign key to the Sensor table, id field.', null, null);
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('datastream', 'idobservedproperty', 'FK Observed Property', 'FK Observed Property', 'Foreign key to the Observed Property table, id field.', null, null);
...
INSERT INTO gpkg_data_columns (table_name, column_name, name, title, description, mime_type, constraint_name) VALUES ('observation', 'iddatastream', 'FK Datastream', 'FK Datastream', 'Foreign key to the Datstream table, id field.', null, null);
