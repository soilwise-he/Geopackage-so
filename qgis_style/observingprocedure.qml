...
<qgis styleCategories="LayerConfiguration|Symbology|Fields|Forms|Actions|Relations" readOnly="0" version="3.44.0-Solothurn">
  ...
  <aliases>
    ...
    <alias field="properties" index="5" name=""/>
  </aliases>
  <splitPolicies>
  ...
  <attributeactions>
    ...
    <actionsetting icon="" shortTitle="Go to Page" isEnabledOnlyWhenEditable="0" id="{31b59619-d87f-45ca-9b6b-7fc91427fd2c}" capture="0" type="5" notificationMessage="" name="Search on web based on attribute's value" action="[%definition%]">
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsed="0" visibilityExpressionEnabled="0" columnCount="1" visibilityExpression="" horizontalStretch="0" verticalStretch="0" type="Row" showLabel="0" name="Definition" groupBox="0" collapsedExpressionEnabled="0" collapsedExpression="">
      ...
      <attributeEditorAction ActionUUID="{31b59619-d87f-45ca-9b6b-7fc91427fd2c}" horizontalStretch="0" verticalStretch="0" showLabel="1" name="{31b59619-d87f-45ca-9b6b-7fc91427fd2c}">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="">
          <labelFont bold="0" italic="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" underline="0"/>
        </labelStyle>
    ...
    <attributeEditorContainer collapsed="0" visibilityExpressionEnabled="0" columnCount="1" visibilityExpression="" horizontalStretch="0" verticalStretch="0" type="GroupBox" showLabel="1" name="RELATIONS" groupBox="1" collapsedExpressionEnabled="0" collapsedExpression="">
      ...
      <attributeEditorContainer collapsed="1" visibilityExpressionEnabled="0" columnCount="1" visibilityExpression="" horizontalStretch="0" verticalStretch="0" type="GroupBox" showLabel="1" name="Sensor" groupBox="1" collapsedExpressionEnabled="0" collapsedExpression="">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="">
          <labelFont bold="0" italic="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" underline="0"/>
        </labelStyle>
        <attributeEditorRelation relationWidgetTypeId="relation_editor" horizontalStretch="0" relation="observingprocedure_obsprocedure_sensor_2" verticalStretch="0" label="" showLabel="0" name="observingprocedure_obsprocedure_sensor_2" forceSuppressFormPopup="0" nmRelationId="">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="">
            <labelFont bold="0" italic="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" underline="0"/>
          </labelStyle>
      ...
      <attributeEditorContainer collapsed="1" visibilityExpressionEnabled="0" columnCount="1" visibilityExpression="" horizontalStretch="0" verticalStretch="0" type="GroupBox" showLabel="1" name="Observed Properties" groupBox="1" collapsedExpressionEnabled="0" collapsedExpression="">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="">
          <labelFont bold="0" italic="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" underline="0"/>
        </labelStyle>
        <attributeEditorRelation relationWidgetTypeId="relation_editor" horizontalStretch="0" relation="observingprocedure_obsprocedure_obsdproperty_2" verticalStretch="0" label="" showLabel="0" name="observingprocedure_obsprocedure_obsdproperty_2" forceSuppressFormPopup="0" nmRelationId="">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="">
            <labelFont bold="0" italic="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" underline="0"/>
          </labelStyle>
          <editor_configuration type="Map">
  ...
  <widgets>
    <widget name="observingprocedure_datastream_5">
      <config type="Map">
        <Option value="false" type="bool" name="force-suppress-popup"/>
        <Option type="invalid" name="nm-rel"/>
      </config>
    </widget>
    <widget name="observingprocedure_obsprocedure_obsdproperty_2">
      <config type="Map">
        <Option value="false" type="bool" name="force-suppress-popup"/>
