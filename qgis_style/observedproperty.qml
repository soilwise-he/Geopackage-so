...
<qgis styleCategories="LayerConfiguration|Symbology|Fields|Forms|Actions|Relations" readOnly="0" version="3.44.0-Solothurn">
  ...
  <constraints>
    ...
    <constraint field="definition" constraints="1" exp_strength="0" notnull_strength="1" unique_strength="0"/>
  ...
  <attributeactions>
    ...
    <actionsetting icon="" shortTitle="Go to Page" isEnabledOnlyWhenEditable="0" id="{a110943f-7cbb-4017-85fa-c020753a2ccd}" capture="0" type="5" notificationMessage="" name="Search on web based on attribute's value" action="[%definition%]">
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsed="0" visibilityExpressionEnabled="0" columnCount="1" visibilityExpression="" horizontalStretch="0" verticalStretch="0" type="Row" showLabel="0" name="Definition" groupBox="0" collapsedExpressionEnabled="0" collapsedExpression="">
      ...
      <attributeEditorAction ActionUUID="{a110943f-7cbb-4017-85fa-c020753a2ccd}" horizontalStretch="0" verticalStretch="0" showLabel="1" name="{a110943f-7cbb-4017-85fa-c020753a2ccd}">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="">
          <labelFont bold="0" italic="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" underline="0"/>
        </labelStyle>
    ...
    <attributeEditorContainer collapsed="1" visibilityExpressionEnabled="0" columnCount="1" visibilityExpression="" horizontalStretch="0" verticalStretch="0" type="GroupBox" showLabel="1" name="Observing Procedure" groupBox="1" collapsedExpressionEnabled="0" collapsedExpression="">
      <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="">
        <labelFont bold="0" italic="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" underline="0"/>
      </labelStyle>
      <attributeEditorRelation relationWidgetTypeId="relation_editor" horizontalStretch="0" relation="observedproperty_obsprocedure_obsdproperty" verticalStretch="0" label="" showLabel="0" name="observedproperty_obsprocedure_obsdproperty" forceSuppressFormPopup="0" nmRelationId="">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="">
          <labelFont bold="0" italic="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" underline="0"/>
        </labelStyle>
  ...
  <widgets>
    <widget name="observedproperty_datastream_6">
      <config type="Map">
        <Option value="false" type="bool" name="force-suppress-popup"/>
        <Option type="invalid" name="nm-rel"/>
      </config>
    </widget>
    <widget name="observedproperty_obsprocedure_obsdproperty">
      <config type="Map">
        <Option value="false" type="bool" name="force-suppress-popup"/>
